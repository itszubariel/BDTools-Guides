...
### [HTTP Guide](http/) · [guides.bdtools.xyz/http](https://guides.bdtools.xyz/http)
...
### [Components V2 Guide](compv2/) · [guides.bdtools.xyz/compv2](https://guides.bdtools.xyz/compv2)
...
### [Text Splitting Guide](textsplit/) · [guides.bdtools.xyz/textsplit](https://guides.bdtools.xyz/textsplit)
...
### [JSON Guide](json/) · [guides.bdtools.xyz/json](https://guides.bdtools.xyz/json)
...
BDTools-Guides/
├── http/           # HTTP guide
├── compv2/         # Components V2 guide
├── textsplit/      # Text Splitting guide
└── json/           # JSON guide
```
